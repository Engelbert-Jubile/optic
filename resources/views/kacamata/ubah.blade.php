        ...
        <div class="shadow p-3 bg-body rounded">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jenis" name="jenis" value="{{$kacamata->jenis_kacamata}}">
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Harga Kacamata</label>
                    <input type="number" class="form-control" id="harga" name="harga" value="{{$kacamata->harga_kacamata}}">
                </div>
