...
<body>
    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="shadow p-3 bg-body rounded">
            ...
            <table id="table">
                ...
                <tbody>
                    @foreach($kacamatas as $kacamata)
                        <tr>
                            <td>{{$kacamata->id_kacamata}}</td>
                            <td>{{$kacamata->jenis_kacamata}}</td>
                            <td>Rp. {{number_format("$kacamata->harga_kacamata",2)}}</td>
                            <td>
                                <a href="kacamata/ubah/{{$kacamata->id_kacamata}}" class="btn btn-warning">
                                    UBAH
                                </a>
                                <a href="kacamata/hapus/{{$kacamata->id_kacamata}}" class="btn btn-danger">
                                    HAPUS
                                </a>
                            </td>
                        </tr>
            ...
            <a href="kacamata/tambah" class="btn btn-primary mt-3 w-100">TAMBAH</a>
        </div>
    </div>
    <script>
