    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="shadow p-3 bg-body rounded">
            <h1 class="text-center mb-5">
                Tambah Transaksi {{$customer->nama_customer}}
            </h1> 
                ...
                <div class="mb-3">
                    ...
                    <select name="kacamata" id="kacamata" class="form-select">
                        @foreach($kacamatas as $kacamata)
                            <option value="{{$kacamata->id_kacamata}}">{{$kacamata->id_kacamata." - ".$kacamata->jenis_kacamata." - Rp. ".number_format("$kacamata->harga_kacamata",2)}}</option>
                        @endforeach
                    </select>
                </div>
