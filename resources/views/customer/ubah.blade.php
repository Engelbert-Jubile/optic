        ...
        <div class="shadow p-3 bg-body rounded">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="{{$customer->nama_customer}}">
                </div>
                <div class="mb-3">
                    <label for="telepon" class="form-label">Telepon</label>
                    <input type="text" class="form-control" id="telepon" name="telepon" value="{{$customer->telepon_customer}}">
                </div>
                <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat</label>
                    <input type="text" class="form-control" id="alamat" name="alamat" value="{{$customer->alamat_customer}}">
                </div>
